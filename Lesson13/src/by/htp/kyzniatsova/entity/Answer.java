...
//		this.id = target.ordinal();
		this.answer = answer;
//		quest = new LinkedList<String>();
//		quest.addAll(showLoveAnswer());
	}
...
/*	public Queue<String> showLoveAnswer(){
		Queue<String> quest = new LinkedList<String>();
//		if(id == 0) {
		if(answer.equals(targetLove)) {
